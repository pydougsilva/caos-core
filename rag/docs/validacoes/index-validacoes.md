...
| T5.2 | T5.2-retomada-real-resumption-index.md | 2026-05-31 | protocolo | experimental | Plano: retomada real via resumption-index — duas fases (estrutural vs operacional); hipótese: snapshot_ref é proveniência ou deve compor o caminho mínimo? |
