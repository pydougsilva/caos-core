...
| T5.1 | T5.1-bootstrap-adapter-layer.md | 2026-05-31 | protocolo | homologado | Bootstrap via CLAUDE.md (Claude Code) e .caos/adapters/codex.md (Codex): ambos convergem em AGENTS.md, auto-identificam papel e aguardam autorização |
| T5.2 | T5.2-retomada-real-resumption-index.md | 2026-06-03 | protocolo | homologado | snapshot_ref NÃO é proveniência — é o 5º elemento do caminho operacional. Renomear para snapshot_minimo. Validado por Claude + Codex em papéis opostos. T_ret_B ≤ 6 min ✓ |
